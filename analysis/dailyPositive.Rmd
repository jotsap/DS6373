...
#t <- 1:length(COVID_totals_final$pos_sum)
t <- as.numeric(COVID_totals_final$date - min(COVID_totals_final$date) + 1 )
new_pos <- COVID_totals_final$new_pos
is_weekend <- COVID_totals_final$is_weekend
hospital_sum <- COVID_totals_final$hospital_sum
